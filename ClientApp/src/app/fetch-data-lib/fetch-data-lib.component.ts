...
@Component({
  ...
  templateUrl: './fetch-data-lib.component.html'
})
export class FetchDataLibComponent implements OnInit {
  ...
  //  }, error => console.error(error));
   ...
   async ngOnInit() {
     ...
     await this.http.getPersonsDataByLib().subscribe((data: PersonDataOutput[]) => this.personsData = data);
